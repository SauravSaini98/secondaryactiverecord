    ...
    class SavepointTransaction < Transaction
      def initialize(connection, savepoint_name, parent_transaction, options, *args)
        ...
        if options[:isolation]
          raise SecondaryActiveRecord::TransactionIsolationError, "cannot set transaction isolation in a nested transaction"
        end
    ...
    class TransactionManager #:nodoc:
      ...
      private
        ...
        def after_failure_actions(transaction, error)
          ...
          return unless error.is_a?(SecondaryActiveRecord::PreparedStatementCacheExpired)
