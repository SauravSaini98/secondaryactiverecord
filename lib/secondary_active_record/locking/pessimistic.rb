...
module SecondaryActiveRecord
  module Locking
    ...
    #
    # Chain <tt>SecondaryActiveRecord::Base#find</tt> to <tt>SecondaryActiveRecord::QueryMethods#lock</tt> to obtain an exclusive
    ...
    #   end
    #
    # You can also use <tt>SecondaryActiveRecord::Base#lock!</tt> method to lock one record by id.
