...
module SecondaryActiveRecord
  module ModelSchema
    ...
    module ClassMethods
      ...
      # inheritance hierarchy descending directly from SecondaryActiveRecord::Base. So if the hierarchy
      # looks like: Reply < Message < SecondaryActiveRecord::Base, then Message is used
      ...
      #
      #   class Mouse < SecondaryActiveRecord::Base
      ...
      # reserved word inside Secondary Active Record. To be able to use single-table
      ...
      # default values when instantiating the Secondary Active Record object for this table.
      def column_defaults
        load_schema
      ...
      # values, eg:
      #
      #  class CreateJobLevels < SecondaryActiveRecord::Migration[5.0]
      #    def up
