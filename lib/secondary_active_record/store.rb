...
module SecondaryActiveRecord
  ...
  #
  # All stored values are automatically available through accessors on the Secondary Active Record
  ...
  module Store
    ...
    private
      ...
      class IndifferentHashAccessor < SecondaryActiveRecord::Store::HashAccessor # :nodoc:
        ...
        def initialize(attr_name, coder_or_class_name)
          @coder =
            if coder_or_class_name.respond_to?(:load) && coder_or_class_name.respond_to?(:dump)
              ...
              SecondaryActiveRecord::Coders::YAMLColumn.new(attr_name, coder_or_class_name || Object)
            end
        end
