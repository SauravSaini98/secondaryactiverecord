...
module SecondaryActiveRecord
  # = Secondary Active Record \Timestamp
  #
  # Secondary Active Record automatically timestamps create and update operations if the
  # table has fields named <tt>created_at/created_on</tt> or
  # <tt>updated_at/updated_on</tt>.
  #
  # Timestamping can be turned off by setting:
  #
  #   config.secondary_active_record.record_timestamps = false
  #
  # Timestamps are in UTC by default but you can use the local timezone by setting:
  #
  #   config.secondary_active_record.default_timezone = :local
  #
  # == Time Zone aware attributes
  #
  # Secondary Active Record keeps all the <tt>datetime</tt> and <tt>time</tt> columns
  ...
  #
  #   config.secondary_active_record.time_zone_aware_attributes = false
  #
  # You can also specify that only <tt>datetime</tt> columns should be time-zone
  # aware (while <tt>time</tt> should not) by setting:
  #
  #   SecondaryActiveRecord::Base.time_zone_aware_types = [:datetime]
  #
  # You can also add database specific timezone aware types. For example, for PostgreSQL:
  #
  #   SecondaryActiveRecord::Base.time_zone_aware_types += [:tsrange, :tstzrange]
  #
