...
if SecondaryActiveRecord::Base.connection.supports_virtual_columns?
  class Mysql2VirtualColumnTest < SecondaryActiveRecord::Mysql2TestCase
    include SchemaDumpingHelper

    self.use_transactional_tests = false

    class VirtualColumn < SecondaryActiveRecord::Base
    end
