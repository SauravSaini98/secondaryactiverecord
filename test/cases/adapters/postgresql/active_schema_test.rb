...
class PostgresqlActiveSchemaTest < SecondaryActiveRecord::PostgreSQLTestCase
  def setup
    SecondaryActiveRecord::ConnectionAdapters::PostgreSQLAdapter.class_eval do
  ...
  def test_add_index
    ...
    SecondaryActiveRecord::ConnectionAdapters::PostgreSQLAdapter.send(:define_method, :index_name_exists?) { |*| false }
    ...
    SecondaryActiveRecord::ConnectionAdapters::PostgreSQLAdapter.send :remove_method, :index_name_exists?
  end

  def test_remove_index
    # remove_index calls index_name_for_remove which can't work since execute is stubbed
    SecondaryActiveRecord::ConnectionAdapters::PostgreSQLAdapter.send(:define_method, :index_name_for_remove) do |*|
    ...
    SecondaryActiveRecord::ConnectionAdapters::PostgreSQLAdapter.send :remove_method, :index_name_for_remove
  end
