...
class PostgresqlHstoreTest < SecondaryActiveRecord::PostgreSQLTestCase
  include SchemaDumpingHelper
  class Hstore < SecondaryActiveRecord::Base
  ...
  def test_hstore_migration
    hstore_migration = Class.new(SecondaryActiveRecord::Migration::Current) do
      def change
