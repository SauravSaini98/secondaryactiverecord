...
if SecondaryActiveRecord::Base.connection.respond_to?(:supports_ranges?) && SecondaryActiveRecord::Base.connection.supports_ranges?
  class PostgresqlRange < SecondaryActiveRecord::Base
    self.table_name = "postgresql_ranges"
    self.time_zone_aware_types += [:tsrange, :tstzrange]
  end

  class PostgresqlRangeTest < SecondaryActiveRecord::PostgreSQLTestCase
...
_SQL
    ...
    def test_tsrange_values
      tz = ::SecondaryActiveRecord::Base.default_timezone
