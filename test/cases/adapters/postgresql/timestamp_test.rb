...
class PostgresqlTimestampTest < SecondaryActiveRecord::PostgreSQLTestCase
  class PostgresqlTimestampWithZone < SecondaryActiveRecord::Base; end
...
class PostgresqlTimestampFixtureTest < SecondaryActiveRecord::PostgreSQLTestCase
  fixtures :topics
