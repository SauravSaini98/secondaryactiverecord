...
class NestedThroughAssociationsTest < SecondaryActiveRecord::TestCase
  ...
  def test_has_many_through_has_one_with_has_many_through_source_reflection_preload
    SecondaryActiveRecord::Base.connection.table_alias_length  # preheat cache
  ...
  def test_nested_has_many_through_writers_should_raise_error
    ...
    assert_raises(SecondaryActiveRecord::HasManyThroughNestedAssociationsAreReadonly) do
  ...
  def test_nested_has_one_through_writers_should_raise_error
    ...
    assert_raises(SecondaryActiveRecord::HasOneThroughNestedAssociationsAreReadonly) do
