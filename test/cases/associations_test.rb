...
class AssociationsTest < SecondaryActiveRecord::TestCase
  ...
  def test_bad_collection_keys
    assert_raise(ArgumentError, "SecondaryActiveRecord should have barked on bad collection keys") do
      Class.new(SecondaryActiveRecord::Base).has_many(:wheels, name: "wheels")
    end
  end
...
class AssociationProxyTest < SecondaryActiveRecord::TestCase
  ...
  test "getting a scope from an association" do
    ...
    assert david.projects.scope.is_a?(SecondaryActiveRecord::Relation)
...
class OverridingAssociationsTest < SecondaryActiveRecord::TestCase
  class DifferentPerson < SecondaryActiveRecord::Base; end

  class PeopleList < SecondaryActiveRecord::Base
...
class GeneratedMethodsTest < SecondaryActiveRecord::TestCase
  ...
  class MyArticle < SecondaryActiveRecord::Base
