...
class OverloadedType < SecondaryActiveRecord::Base
...
class UnoverloadedType < SecondaryActiveRecord::Base
  self.table_name = "overloaded_types"
end

module SecondaryActiveRecord
  class CustomPropertiesTest < SecondaryActiveRecord::TestCase
    ...
    test "nonexistent attribute" do
      ...
      assert_raise SecondaryActiveRecord::UnknownAttributeError do
    ...
    test "attributes added after subclasses load are inherited" do
      parent = Class.new(SecondaryActiveRecord::Base) do
    ...
    test "attributes not backed by database columns properly interact with mutation and dirty" do
      child = Class.new(SecondaryActiveRecord::Base) do
        self.table_name = "topics"
