...
class TestAutosaveAssociationsInGeneral < SecondaryActiveRecord::TestCase
  def test_autosave_validation
    person = Class.new(SecondaryActiveRecord::Base) {
    ...
    reference = Class.new(SecondaryActiveRecord::Base) {
...
class TestDefaultAutosaveAssociationOnAHasOneAssociation < SecondaryActiveRecord::TestCase
...
class TestDefaultAutosaveAssociationOnABelongsToAssociation < SecondaryActiveRecord::TestCase
...
class TestDefaultAutosaveAssociationOnAHasManyAssociationWithAcceptsNestedAttributes < SecondaryActiveRecord::TestCase
  ...
  def test_errors_should_be_indexed_when_global_flag_is_set
    old_attribute_config = SecondaryActiveRecord::Base.index_nested_attribute_errors
    SecondaryActiveRecord::Base.index_nested_attribute_errors = true
    ...
    SecondaryActiveRecord::Base.index_nested_attribute_errors = old_attribute_config
  end
...
class TestDefaultAutosaveAssociationOnAHasManyAssociation < SecondaryActiveRecord::TestCase
...
class TestDefaultAutosaveAssociationOnNewRecord < SecondaryActiveRecord::TestCase
...
class TestDestroyAsPartOfAutosaveAssociation < SecondaryActiveRecord::TestCase
...
class TestAutosaveAssociationOnAHasOneAssociation < SecondaryActiveRecord::TestCase
...
class TestAutosaveAssociationOnAHasOneThroughAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationOnABelongsToAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationOnAHasManyAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationOnAHasAndBelongsToManyAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationOnAHasAndBelongsToManyAssociationWithAcceptsNestedAttributes < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationValidationsOnAHasManyAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationValidationsOnAHasOneAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationValidationsOnABelongsToAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationValidationsOnAHABTMAssociation < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationValidationMethodsGeneration < SecondaryActiveRecord::TestCase
  self.use_transactional_tests = false unless supports_savepoints?
...
class TestAutosaveAssociationWithTouch < SecondaryActiveRecord::TestCase
...
class TestAutosaveAssociationOnAHasManyAssociationWithInverse < SecondaryActiveRecord::TestCase
