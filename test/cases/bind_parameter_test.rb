...
if SecondaryActiveRecord::Base.connection.prepared_statements
  module SecondaryActiveRecord
    class BindParameterTest < SecondaryActiveRecord::TestCase
      ...
      def test_deprecate_supports_statement_cache
        assert_deprecated { SecondaryActiveRecord::Base.connection.supports_statement_cache? }
      end
      ...
      private
        def assert_logs_binds(binds)
          ...
          logger = Class.new(SecondaryActiveRecord::LogSubscriber) {
            attr_reader :debugs
