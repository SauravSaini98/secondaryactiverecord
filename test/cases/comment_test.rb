...
if SecondaryActiveRecord::Base.connection.supports_comments?
  class CommentTest < SecondaryActiveRecord::TestCase
    include SchemaDumpingHelper

    class Commented < SecondaryActiveRecord::Base
      self.table_name = "commenteds"
    end

    class BlankComment < SecondaryActiveRecord::Base
    end
