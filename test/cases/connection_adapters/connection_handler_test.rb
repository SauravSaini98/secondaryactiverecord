...
module SecondaryActiveRecord
  module ConnectionAdapters
    class ConnectionHandlerTest < SecondaryActiveRecord::TestCase
      ...
      def setup
        ...
        @spec_name = "primary"
        @pool = @handler.establish_connection(SecondaryActiveRecord::Base.configurations["arunit"])
      end
      ...
      def test_default_env_fall_back_to_default_env_when_rails_env_or_rack_env_is_empty_string
        ...
        assert_equal "default_env", SecondaryActiveRecord::ConnectionHandling::DEFAULT_ENV.call
      ensure
      ...
      def test_establish_connection_using_3_levels_config
        ...
        @prev_configs, SecondaryActiveRecord::Base.configurations = SecondaryActiveRecord::Base.configurations, config
        ...
        SecondaryActiveRecord::Base.configurations = @prev_configs
      ...
      if Process.respond_to?(:fork)
        def test_connection_pool_per_pid
          object_id = SecondaryActiveRecord::Base.connection.object_id
          ...
          pid = fork {
            rd.close
            wr.write Marshal.dump SecondaryActiveRecord::Base.connection.object_id
            wr.close
            exit!
          }
        ...
        def test_forked_child_doesnt_mangle_parent_connection
          object_id = SecondaryActiveRecord::Base.connection.object_id
          assert_predicate SecondaryActiveRecord::Base.connection, :active?
          ...
          pid = fork {
            rd.close
            if SecondaryActiveRecord::Base.connection.active?
              wr.write Marshal.dump SecondaryActiveRecord::Base.connection.object_id
            end
            wr.close
          ...
          assert_equal 3, SecondaryActiveRecord::Base.connection.select_value("SELECT COUNT(*) FROM people")
        end
        ...
        unless in_memory_db?
          def test_forked_child_recovers_from_disconnected_parent
            ...
            outer_pid = fork {
              SecondaryActiveRecord::Base.connection.disconnect!

              pid = fork {
                rd.close
                if SecondaryActiveRecord::Base.connection.active?
                  pair = [SecondaryActiveRecord::Base.connection.object_id,
                          SecondaryActiveRecord::Base.connection.select_value("SELECT COUNT(*) FROM people")]
            ...
            assert_equal 6, SecondaryActiveRecord::Base.connection.select_value("SELECT 2 * COUNT(*) FROM people")
          end
        end
        ...
        def test_pool_from_any_process_for_uses_most_recent_spec
          ...
          pid = fork do
            SecondaryActiveRecord::Base.configurations["arunit"]["database"] = file.path
            SecondaryActiveRecord::Base.establish_connection(:arunit)

            pid2 = fork do
              wr.write SecondaryActiveRecord::Base.connection_config[:database]
              wr.close
            end
        ...
        def test_a_class_using_custom_pool_and_switching_back_to_primary
          ...
          assert_same klass2.connection, SecondaryActiveRecord::Base.connection

          pool = klass2.establish_connection(SecondaryActiveRecord::Base.connection_pool.spec.config)
          assert_same klass2.connection, pool.connection
          refute_same klass2.connection, SecondaryActiveRecord::Base.connection
        ...
        def test_remove_connection_should_not_remove_parent
          klass2 = Class.new(Base) { def self.name; "klass2"; end }
          klass2.remove_connection
          refute_nil SecondaryActiveRecord::Base.connection
          assert_same klass2.connection, SecondaryActiveRecord::Base.connection
        end
      end
    end
