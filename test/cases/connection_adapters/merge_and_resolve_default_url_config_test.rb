...
module SecondaryActiveRecord
  module ConnectionAdapters
    class MergeAndResolveDefaultUrlConfigTest < SecondaryActiveRecord::TestCase
      def setup
      ...
      def resolve_config(config)
        SecondaryActiveRecord::ConnectionHandling::MergeAndResolveDefaultUrlConfig.new(config).resolve
      end
