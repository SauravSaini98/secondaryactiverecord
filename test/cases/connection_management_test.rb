...
module SecondaryActiveRecord
  module ConnectionAdapters
    class ConnectionManagementTest < SecondaryActiveRecord::TestCase
      ...
      def setup
        ...
        assert_predicate SecondaryActiveRecord::Base.connection_handler, :active_connections?
      end
      ...
      def test_connections_are_cleared_after_body_close
        _, _, body = @management.call(@env)
        body.close
        assert_not_predicate SecondaryActiveRecord::Base.connection_handler, :active_connections?
      end
      ...
      private
        def executor
          @executor ||= Class.new(ActiveSupport::Executor).tap do |exe|
            SecondaryActiveRecord::QueryCache.install_executor_hooks(exe)
          end
        end
