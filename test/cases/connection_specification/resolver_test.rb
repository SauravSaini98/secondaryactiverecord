...
module SecondaryActiveRecord
  module ConnectionAdapters
    class ConnectionSpecification
      class ResolverTest < SecondaryActiveRecord::TestCase
        ...
        def test_url_invalid_adapter
          ...
          assert_match "Could not load the 'ridiculous' Secondary Active Record adapter. Ensure that the adapter is spelled correctly in config/secondary_database.yml and that you've added the necessary adapter gem to your Gemfile.", error.message
        end
