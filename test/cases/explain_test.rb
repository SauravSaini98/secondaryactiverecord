...
if SecondaryActiveRecord::Base.connection.supports_explain?
  class ExplainTest < SecondaryActiveRecord::TestCase
    fixtures :cars

    def base
      SecondaryActiveRecord::Base
    end
    ...
    def test_collecting_queries_for_explain
      queries = SecondaryActiveRecord::Base.collecting_queries_for_explain do
    ...
    private
      ...
      def bind_param(name, value)
        SecondaryActiveRecord::Relation::QueryAttribute.new(name, value, SecondaryActiveRecord::Type::Value.new)
      end
  end
end
