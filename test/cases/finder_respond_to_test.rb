...
class FinderRespondToTest < SecondaryActiveRecord::TestCase
  fixtures :topics

  def test_should_preserve_normal_respond_to_behaviour_on_base
    assert_respond_to SecondaryActiveRecord::Base, :new
    assert_not_respond_to SecondaryActiveRecord::Base, :find_by_something
  end
