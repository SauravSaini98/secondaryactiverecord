...
if SecondaryActiveRecord::Base.connection.supports_foreign_keys_in_create?
  module SecondaryActiveRecord
    class Migration
      class ForeignKeyInCreateTest < SecondaryActiveRecord::TestCase
        def test_foreign_keys
          foreign_keys = SecondaryActiveRecord::Base.connection.foreign_keys("fk_test_has_fk")
...
if SecondaryActiveRecord::Base.connection.supports_foreign_keys?
  module SecondaryActiveRecord
    class Migration
      class ForeignKeyTest < SecondaryActiveRecord::TestCase
        include SchemaDumpingHelper
        include ActiveSupport::Testing::Stream

        class Rocket < SecondaryActiveRecord::Base
        end

        class Astronaut < SecondaryActiveRecord::Base
        end
        ...
        if SecondaryActiveRecord::Base.connection.supports_validate_constraints?
        ...
        class CreateCitiesAndHousesMigration < SecondaryActiveRecord::Migration::Current
          def change
        ...
        class CreateSchoolsAndClassesMigration < SecondaryActiveRecord::Migration::Current
          def change
        ...
        def test_add_foreign_key_with_prefix
          ...
          silence_stream($stdout) { migration.migrate(:down) }
          SecondaryActiveRecord::Base.table_name_prefix = nil
        end
        ...
        def test_add_foreign_key_with_suffix
          ...
          silence_stream($stdout) { migration.migrate(:down) }
          SecondaryActiveRecord::Base.table_name_suffix = nil
        end
      end
    end
  end
  ...
  module SecondaryActiveRecord
    class Migration
      class NoForeignKeySupportTest < SecondaryActiveRecord::TestCase
        setup do
          @connection = SecondaryActiveRecord::Base.connection
        end
