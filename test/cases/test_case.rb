...
module SecondaryActiveRecord
  # = Secondary Active Record Test Case
  #
  # Defines some test assertions to test against SQL queries.
  class TestCase < ActiveSupport::TestCase #:nodoc:
    include ActiveSupport::Testing::MethodCallAssertions
    include ActiveSupport::Testing::Stream
    include SecondaryActiveRecord::TestFixtures
    include SecondaryActiveRecord::ValidationsRepairHelper
    ...
    def create_fixtures(*fixture_set_names, &block)
      SecondaryActiveRecord::FixtureSet.create_fixtures(SecondaryActiveRecord::TestCase.fixture_path, fixture_set_names, fixture_class_names, &block)
    end
  ...
  ActiveSupport::Notifications.subscribe("sql.secondary_active_record", SQLCounter.new)
end
