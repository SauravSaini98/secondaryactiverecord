...
class Post < SecondaryActiveRecord::Base
  class CategoryPost < SecondaryActiveRecord::Base
...
class FirstPost < SecondaryActiveRecord::Base
...
class PostWithDefaultInclude < SecondaryActiveRecord::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class PostWithDefaultScope < SecondaryActiveRecord::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
  default_scope { order(:title) }
end

class PostWithPreloadDefaultScope < SecondaryActiveRecord::Base
  self.table_name = "posts"
...
class PostWithIncludesDefaultScope < SecondaryActiveRecord::Base
  self.table_name = "posts"
...
class SpecialPostWithDefaultScope < SecondaryActiveRecord::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class PostThatLoadsCommentsInAnAfterSaveHook < SecondaryActiveRecord::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class PostWithAfterCreateCallback < SecondaryActiveRecord::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
  has_many :comments, foreign_key: :post_id
...
class PostWithCommentWithDefaultScopeReferencesAssociation < SecondaryActiveRecord::Base
  self.inheritance_column = :disabled
  self.table_name = "posts"
...
class SerializedPost < SecondaryActiveRecord::Base
  serialize :title
end
...
class FakeKlass
  extend SecondaryActiveRecord::Delegation::DelegateCache
